...
const pfiveBtn = document.getElementById('plusFive')
const mfiveBtn = document.getElementById('minusFive')

const incrementOdd = document.getElementById('incrementOdd')
const incrementSync = document.getElementById('incrementSync')
...
pfiveBtn.addEventListener('click', addFive)
mfiveBtn.addEventListener('click', subFive)
